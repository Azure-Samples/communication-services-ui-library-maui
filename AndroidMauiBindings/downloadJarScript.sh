...
curl "https://repo1.maven.org/maven2/com/azure/android/azure-communication-ui-calling/1.10.0/azure-communication-ui-calling-1.10.0.aar" --output azure-communication-ui-calling-1.10.0.aar
