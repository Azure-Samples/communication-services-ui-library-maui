...
curl  "https://repo1.maven.org/maven2/com/azure/android/azure-communication-calling/2.13.0/azure-communication-calling-2.13.0.aar" --output azure-communication-calling-2.13.0.aar
