...
curl "https://repo1.maven.org/maven2/com/azure/android/azure-communication-ui-calling/1.11.0/azure-communication-ui-calling-1.12.0.aar" --output azure-communication-ui-calling-1.11.0.aar
...
curl  "https://repo1.maven.org/maven2/com/azure/android/azure-communication-calling/2.12.0/azure-communication-calling-2.12.0.aar" --output azure-communication-calling-2.11.0.aar
