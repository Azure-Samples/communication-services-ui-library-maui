...
namespace iOS.CallingUI.Binding
{
	...
	{
		// -(void)startExperienceWithGroupCall:(GroupCallObjectProxy * _Nonnull)groupCall token:(NSString * _Nonnull)token localData:(CommunicationLocalDataOptionProxy * _Nullable)localData theme:(CommunicationThemeProxy * _Nullable)theme localization:(CommunicationLocalizationProxy * _Nullable)localization orientationProxy:(CommunicationScreenOrientationProxy * _Nullable)orientationProxy enableMultitasking:(BOOL)enableMultitasking enableSystemPictureInPictureWhenMultitasking:(BOOL)enableSystemPictureInPictureWhenMultitasking errorCallback:(void (^ _Nullable)(CommunicationErrorProxy * _Nonnull))errorCallback onRemoteParticipantJoinedCallback:(void (^ _Nullable)(NSArray<NSString *> * _Nonnull))onRemoteParticipantJoinedCallback onCallStateChangedCallback:(void (^ _Nullable)(CommunicationCallStateProxy * _Nonnull))onCallStateChangedCallback onDismissedCallback:(void (^ _Nullable)(CommunicationDismissedProxy * _Nonnull))onDismissedCallback onUserReportedIssueCallback:(void (^ _Nullable)(CallCompositeUserReportedIssueProxy * _Nonnull))onUserReportedIssueCallback;
		[Export ("startExperienceWithGroupCall:token:localData:theme:localization:orientationProxy:enableMultitasking:enableSystemPictureInPictureWhenMultitasking:errorCallback:onRemoteParticipantJoinedCallback:onCallStateChangedCallback:onDismissedCallback:onUserReportedIssueCallback:")]
		void StartExperienceWithGroupCall (GroupCallObjectProxy groupCall, string token, [NullAllowed] CommunicationLocalDataOptionProxy localData, [NullAllowed] CommunicationThemeProxy theme, [NullAllowed] CommunicationLocalizationProxy localization, [NullAllowed] CommunicationScreenOrientationProxy orientationProxy, bool enableMultitasking, bool enableSystemPictureInPictureWhenMultitasking, [NullAllowed] Action<CommunicationErrorProxy> errorCallback, [NullAllowed] Action<NSArray<NSString>> onRemoteParticipantJoinedCallback, [NullAllowed] Action<CommunicationCallStateProxy> onCallStateChangedCallback, [NullAllowed] Action<CommunicationDismissedProxy> onDismissedCallback, [NullAllowed] Action<CallCompositeUserReportedIssueProxy> onUserReportedIssueCallback);
		...
		[Export ("startExperienceWithTeamsMeeting:token:localData:theme:localization:orientationProxy:enableMultitasking:enableSystemPictureInPictureWhenMultitasking:errorCallback:onRemoteParticipantJoinedCallback:onCallStateChangedCallback:onDismissedCallback:onUserReportedIssueCallback:")]
