...
2. Navigate to `/AndroidMauiBindings` and in this directory in terminal run `./downloadJarScript.sh`. `Windows Subsystem for Linux (WSL)` should be enabled to run `.sh` on Windows.
